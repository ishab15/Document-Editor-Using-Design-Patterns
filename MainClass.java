...
class Composite implements CompositeBase {
    ...
    public JTextPane addLeafElement() {
        ...
        editarea2.setPreferredSize(new Dimension(700, 700));
        JScrollPane jp = new JScrollPane(editarea2);
        
        editarea2.setMargin(new Insets(3, 30, 30, 30));
        Font f = new Font("Courier", Font.PLAIN, 30);
        result = new JLabel();
        result.setFont(f);
        result.setPreferredSize(new Dimension(600, 200));
        result.setText("Welcome to Docoment Editor");
        msg.add(result);
        logo = new JLabel();
        title.setLayout(new BorderLayout());
        logo.setSize(new Dimension(150, 150));
        title.add(logo, BorderLayout.WEST);
        logo.setIcon(new ImageIcon("C:\\Users\\ISHA\\Documents\\NetBeansProjects\\DocumentEditor\\src\\documenteditor\\launcher3.png"));
        caption = new JLabel();
        caption.setFont(f);
